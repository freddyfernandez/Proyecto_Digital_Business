...
<body class="animsition">
    ...
    <div class="row">
    	...
    	<div class="col-md-9">
			<form action="ServletAlmacen?tipo=registrarSalida" id="frmagregar" method="post">
	    ...
	    <div class="row m-t-30">
                            <div class="col-md-12">
								...
								<th colspan="1">ACCIONES</th>
                						...
                						%>
                						<tr>
                							<td><%=xAlu.getCodigo_salida()%></td>
                							<td><%=xAlu.getNombre_producto()%></td>
                							<td><%=xAlu.getCantidad_salida()%></td>
                							<td><%=xAlu.getFecha_salida()%></td>
                							


                							<td align="center">
                							 <a
                								href='ServletContacto?tipo=eliminarContacto&codigo_contacto=<%=xAlu.getCodigo_salida()%>'>
