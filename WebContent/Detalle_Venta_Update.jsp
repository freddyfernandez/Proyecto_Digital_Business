	    ...
	    <!-- PAGE CONTAINER-->
           <div class="page-container2">
             ...
             <!-- CONTENIDO-->
    	      ...
    	      <div class="col-md-9">
    	        <%
    	        Detalle_VentaDTO obj=(Detalle_VentaDTO) request.getAttribute("registro");
   
                %>
			   <form action="ServletVenta?tipo=actualizarDetalleVenta" id="frmagregar" method="post">
			     <input type="hidden" name="txt_codigoDetalle" value="<%=obj.getCodigo_detalle() %>" >
			    <div id="contact-form" class="form-container" data-form-container>
			
				<div class="form-title">
					<span>ACTUALIZAR DE PEDIDO</span>
				</div>
			...
			<div class="input-container">
				<div class="row">
					...
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Your First and Last Name."></span>
						<input  type="text" name="txt_codigoProducto" class="required"  value="<%=obj.getCodigo_producto() %>"
						 data-min-length="8" placeholder="" pattern="[0-9]{6,10}" required="required">
					</span>
				...
				-->	
					...
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Your First and Last Name."></span>
						<input  type="text" name="txt_precio_Venta" class="required"  value="<%=obj.getPrecio_venta() %>"
					...
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Your First and Last Name."></span>
						<input  type="text" name="txt_cantidad" class="required" value="<%=obj.getCantidad() %>"
						 data-min-length="8" placeholder="Ingrese Descripcion "
						 pattern="[0-9]{1,10}" required="required">
					</span>
					...
					<span class="req-input" >
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Input Your First and Last Name."></span>
						<input  type="text" name="txt_descuento" class="required" value="<%=obj.getDescuento() %>"
						 data-min-length="8" placeholder="Ingrese Descripcion "
